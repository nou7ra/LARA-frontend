    ...
    const fetchProfile = async () => {
      try {
        ...
        if (savedUser) {
          ...
          if (user.name) setInitial(user.name.charAt(0).toUpperCase());
  ...
  return (
    <header className="h-[70px] sticky top-0 z-50 flex items-center justify-between px-9 shadow-lg"
      ...
      <nav className="hidden md:flex gap-5 text-sm">
        ...
        <Link href="/dashboard" className="text-gray-800 font-semibold border-b-2 border-gray-800 pb-0.5">Dashboard</Link>
